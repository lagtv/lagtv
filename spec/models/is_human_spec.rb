...
describe IsHuman do
  ...
  it "checks that a given answer matches the hash generated by a previous question" do
    params = { :is_human_attempt => 9, :is_human_hash => "a42198ba9a8c4111a7912c9a21c358df89596b94" }
    IsHuman.correct?(params).should be_true
  end

  it "removes the is_human keys from the pasted hash when checking the answer" do
